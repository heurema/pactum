...
// or only comments never changes this hash; changing a map parameter does.
...
func (a App) refreshMap(root string, startedAt time.Time) (MapRefreshResult, error) {
	...
	// Remove any stale code-items.jsonl left by a previous pactum version.
	// It is no longer generated; silently ignore a missing file.
	_ = os.Remove(paths.CodeItemsJSONL)
