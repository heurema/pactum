...
- Validation command results:
  - command_001: go test ./internal/app -run TestReviewLoop -count=1 (exit 0, timed out: false, result: gate/validation/command_001/result.json)
