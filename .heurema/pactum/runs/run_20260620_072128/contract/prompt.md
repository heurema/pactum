...
- Approval: approved
- Contract hash: ca1b0fd68aee7808643da0ba0efd22c3f0b89c36b57711febe7ff592230d9a73
...
Items:
- mem_025 [fresh] score=77 — Make the review loop (both contract_review and code_review, which share inter...
- mem_021 [fresh] score=71 — Make pactum's code-review loop never silently drop reviewer findings, and rec...
- mem_015 [fresh] score=61 — Extract a shared bounded-loop engine into a new internal/loop package and por...
- mem_017 [fresh] score=59 — Rework the pactum config to the new pipeline shape and wire it through the ex...
