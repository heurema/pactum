...
## Run
- Run id: run_20260609_185135
- Run status: contract_draft

## Contract draft
- Goal: Add a command that deletes run records older than N days
- In scope:
  - none
- Out of scope:
  - none
...
Generated: 2026-06-09T18:51:35Z
...
Generated: 2026-06-09T18:43:35Z
...
- Indexed files: 129
- Ignored files/directories: 761
- Detected languages: 6
- Code items (best-effort hints): 1383
...
## Search results
{
  "query": "Add a command that deletes run records older than N days",
  "queries": [
    "command",
    "deletes",
    "records",
