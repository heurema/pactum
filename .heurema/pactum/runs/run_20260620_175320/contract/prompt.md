...
## Contract status
- Run: run_20260620_175320
- Approval: approved
- Contract hash: 6c3a68c62692593e0063c59fd4b1b3afacfce570a5206212db0a8b7feaa98620
...
Items:
- mem_026 [fresh] score=73 — Add an absolute per-attempt WALL-CLOCK CAP to the ACP agent transport so an a...
- mem_018 [fresh] score=57 — Add a new top-level CLI command 'pactum usage [run_id]' that summarizes agent...
- mem_002 [stale] score=54 — Normalize the CLI command grammar for agent-first use: every stage exposes a ...
  reason: missing file internal/app/agents_doctor.go
  reason: missing file internal/app/agents_doctor_test.go
- mem_021 [fresh] score=52 — Make pactum's code-review loop never silently drop reviewer findings, and rec...
- mem_015 [fresh] score=52 — Extract a shared bounded-loop engine into a new internal/loop package and por...
