...
- Approval: approved
- Contract hash: 2d27f0d5a7a8d70f2315c703a089a645b13444f5b31c4b1f3c5925eb1da4d4cf
...
Items:
- mem_021 [fresh] score=99 — Make pactum's code-review loop never silently drop reviewer findings, and rec...
- mem_009 [fresh] score=79 — Slice 1 of the agent file-navigation arc (design reference: docs/agent-file-n...
- mem_020 [fresh] score=78 — Add the plan-DAG schema and structural validation to the contract — slice 1 o...
- mem_022 [fresh] score=76 — Plan-DAG slice 2: the contract drafter emits an optional plan.tasks[] DAG, an...
- mem_005 [fresh] score=75 — Make the CLI announce legal moves so an agent never guesses the pipeline stat...
