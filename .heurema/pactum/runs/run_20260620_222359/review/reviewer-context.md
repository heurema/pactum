...
- Validation command results:
  - command_001: grep -rq 'func TestGitGuard' internal/app/ (exit 0, timed out: false, result: gate/validation/command_001/result.json)
  - command_002: go test -v -count=1 ./internal/app -run 'TestGitGuard' (exit 0, timed out: false, result: gate/validation/command_002/result.json)
  - command_003: go test -count=1 ./internal/app ./internal/gitctx (exit 0, timed out: false, result: gate/validation/command_003/result.json)
