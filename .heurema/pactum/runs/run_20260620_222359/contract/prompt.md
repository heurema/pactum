...
## Contract status
- Run: run_20260620_222359
- Approval: approved
- Contract hash: 47b4a7699f04dc66ad5ba40de60f3f69d47b83522473c565144cb19d505be3f8
...
Items:
- mem_002 [stale] score=83 — Normalize the CLI command grammar for agent-first use: every stage exposes a ...
  reason: missing file internal/app/agents_doctor.go
  reason: missing file internal/app/agents_doctor_test.go
- mem_005 [fresh] score=82 — Make the CLI announce legal moves so an agent never guesses the pipeline stat...
- mem_018 [fresh] score=73 — Add a new top-level CLI command 'pactum usage [run_id]' that summarizes agent...
- mem_021 [fresh] score=72 — Make pactum's code-review loop never silently drop reviewer findings, and rec...
- mem_028 [fresh] score=71 — Make the pactum agent skill self-sufficient and one-command installable, so a...
