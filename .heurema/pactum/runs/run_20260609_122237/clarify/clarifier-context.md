...
## Run
- Run id: run_20260609_122237
- Run status: contract_draft

## Contract draft
- Goal: Add a retry mechanism for flaky operations
- In scope:
  - none
- Out of scope:
  - none
...
Generated: 2026-06-09T12:22:37Z
...
Generated: 2026-06-09T12:14:16Z
...
- Indexed files: 129
- Ignored files/directories: 671
- Detected languages: 6
- Code items (best-effort hints): 1380
...
## Search results
{
  "query": "Add a retry mechanism for flaky operations",
  "queries": [
    "retry",
    "mechanism",
    "flaky",
