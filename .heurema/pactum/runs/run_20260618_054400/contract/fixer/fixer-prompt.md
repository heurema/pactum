...
Current contract version: c9a13f023fd24a4b2bdc23868b488db8642f1f035a7b3f36492c9cc376123acf
...
1. [codex-xhigh/testability] The CLI help-output acceptance criterion is not fully backed by a machine-checkable test requirement. The contract requires `pactum plan show` to appear in CLI help, but only requires a parser-recognition test.
   Evidence: `pactum plan show is registered in the CLI grammar and appears in CLI help output; a test asserts the command name is recognised by the command parser without error.`
2. [codex-xhigh/assumptions-surfaced] The no-plan JSON output shape for pactum plan show --json is left ambiguous, which affects executor behavior and test expectations for the new CLI surface.
   Evidence: Acceptance criteria: "pactum plan show --json emits structured plan data when present and an explicit empty or absent plan representation when no plan exists."
...
```json
{
  ...
  "base_version": "c9a13f023fd24a4b2bdc23868b488db8642f1f035a7b3f36492c9cc376123acf",
  "contract": {
