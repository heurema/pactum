...
Items:
- mem_020 [fresh] score=82 — Add the plan-DAG schema and structural validation to the contract — slice 1 o...
- mem_021 [fresh] score=75 — Make pactum's code-review loop never silently drop reviewer findings, and rec...
- mem_018 [fresh] score=72 — Add a new top-level CLI command 'pactum usage [run_id]' that summarizes agent...
- mem_002 [stale] score=63 — Normalize the CLI command grammar for agent-first use: every stage exposes a ...
  reason: missing file internal/app/agents_doctor.go
  reason: missing file internal/app/agents_doctor_test.go
- mem_009 [fresh] score=62 — Slice 1 of the agent file-navigation arc (design reference: docs/agent-file-n...
