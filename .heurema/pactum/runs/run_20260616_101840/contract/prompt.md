...
## Contract status
- Run: run_20260616_101840
- Approval: approved
- Contract hash: 9f7f9c8f2824c62f3623b64ad093f75b0822007db5a37ebc91813ef7f83d8b48
...
Items:
- mem_002 [stale] score=78 — Normalize the CLI command grammar for agent-first use: every stage exposes a ...
...
- mem_009 [fresh] score=60 — Slice 1 of the agent file-navigation arc (design reference: docs/agent-file-n...
- mem_007 [fresh] score=43 — Fix three valid external review findings. (1) pactum export must preserve its...
- mem_013 [fresh] score=41 — Dogfood Pactum with a local codex-acp adapter that returns official ACP Promp...
