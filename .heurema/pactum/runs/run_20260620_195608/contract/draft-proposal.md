...
- Drafter: codex
- Accepted by: manual
- Accepted at: 2026-06-20T19:58:10Z
...
- Update contract-review prompt rendering so reviewer output uses the contract reviewer result schema and no longer asks for the code-review reviewer_findings schema.
...
- Update internal/app/contract_review_test.go helpers and tests to cover prompt text, new field propagation, material_impact downgrade behavior, and wording/completeness-preference findings staying non-blocking.
