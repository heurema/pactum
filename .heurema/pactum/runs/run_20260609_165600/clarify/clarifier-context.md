...
## Run
- Run id: run_20260609_165600
- Run status: contract_draft

## Contract draft
- Goal: Add a plugin system so users can register custom agents beyond the built-in codex and claude
- In scope:
  - none
- Out of scope:
  - none
...
Generated: 2026-06-09T16:56:00Z
...
Generated: 2026-06-09T16:30:22Z
...
- Indexed files: 129
- Ignored files/directories: 701
- Detected languages: 6
- Code items (best-effort hints): 1381
...
## Search results
{
  "query": "Add a plugin system so users can register custom agents beyond the built-in codex and claude",
  "queries": [
    "built-in",
    "built",
    "plugin",
