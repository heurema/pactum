...
Current contract version: fcbb667afbc1f00b5662772e2f4b5130459723a28fea410cc69ec7aa077c314e
...
1. [codex/testability] The acceptance criteria require changing the real contract-reviewer prompt grammar, but the test plan does not explicitly require a runnable assertion against the prompt text or prompt builder.
   Evidence: PREREQUISITE GRAMMAR CHANGE: make the contract reviewer findings block mandatory... plus test scope only says to change the fake reviewer CLEAN path and add loop behavior coverage.
...
```json
{
  ...
  "base_version": "fcbb667afbc1f00b5662772e2f4b5130459723a28fea410cc69ec7aa077c314e",
  "contract": {
