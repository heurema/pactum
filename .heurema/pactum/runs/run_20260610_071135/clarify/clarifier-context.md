...
## Run
- Run id: run_20260610_071135
- Run status: contract_draft

## Contract draft
- Goal: Outline next steps for test coverage
- In scope:
  - none
- Out of scope:
  - none
...
Generated: 2026-06-10T07:11:35Z
...
Generated: 2026-06-10T06:59:43Z
...
- Indexed files: 132
- Ignored files/directories: 906
- Detected languages: 6
- Code items (best-effort hints): 1422
...
## Search results
{
  "query": "Outline next steps for test coverage",
  "queries": [
    "outline",
    "next",
    "steps",
