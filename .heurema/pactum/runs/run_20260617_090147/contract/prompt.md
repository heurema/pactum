...
- Approval: approved
- Contract hash: 13f02335d9a312e8005f2e06d596c93f53a3963b5299b31b022588f6c665fe87
...
Items:
- mem_002 [stale] score=71 — Normalize the CLI command grammar for agent-first use: every stage exposes a ...
  reason: missing file internal/app/agents_doctor.go
  reason: missing file internal/app/agents_doctor_test.go
- mem_007 [fresh] score=68 — Fix three valid external review findings. (1) pactum export must preserve its...
- mem_016 [fresh] score=61 — Port the code-review loop (internal/app/review_loop.go) onto the existing int...
- mem_005 [fresh] score=56 — Make the CLI announce legal moves so an agent never guesses the pipeline stat...
- mem_011 [fresh] score=53 — Stagger the cold start of same-model reviewer groups in the review panel fan-...
