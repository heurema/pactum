...
- Validation command results:
  - command_001: go test ./internal/app -run TestReadConfig (exit 0, timed out: false, result: gate/validation/command_001/result.json)
  ...
  - command_005: [ $(grep -rEn --include='*.go' 'config\.(Schema|Review|Contract|Gate|Clarify|Timeouts)' internal/ | grep -v _test\.go | wc -l) -eq 0 ] (exit 0, timed out: false, result: gate/validation/command_005/result.json)
- Change summary:
  - changed files:
