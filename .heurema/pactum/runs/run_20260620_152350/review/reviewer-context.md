...
- Validation command results:
  - command_001: go test ./internal/gitctx ./internal/projectmap ./internal/app (exit 0, timed out: false, result: gate/validation/command_001/result.json)
  - command_002: make check (exit 0, timed out: false, result: gate/validation/command_002/result.json)
  - command_003: find internal/gitctx -name '*.go' ! -name '*_test.go' | xargs grep -lF 'exec.CommandContext' | grep -q . (exit 0, timed out: false, result: gate/validation/command_003/result.json)
  - command_004: ! grep -qF '"os/exec"' internal/projectmap/scan.go internal/app/review_loop.go (exit 0, timed out: false, result: gate/validation/command_004/result.json)
- Change summary:
  - changed files:
