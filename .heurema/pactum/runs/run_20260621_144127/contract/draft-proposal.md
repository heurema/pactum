...
- Drafter: codex
- Accepted by: manual
- Accepted at: 2026-06-21T14:42:56Z
...
- Add a code comment near the removed or replaced worktree guard explaining linked-worktree support and the accepted residual shared-ref edge.
...
- A code comment documents that refs are shared across linked worktrees, that git refusing to restore a ref checked out elsewhere will surface as executor_git_restore_failed, and that concurrent git activity in another worktree remains an accepted nonblocking residual risk.
- make check passes.
