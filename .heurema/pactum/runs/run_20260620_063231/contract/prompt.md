...
- Approval: approved
- Contract hash: b707c298b8ab1f556fe359cf318d648f668b3ddb525d0650c492e4df139c45ff
...
Items:
- mem_002 [stale] score=94 — Normalize the CLI command grammar for agent-first use: every stage exposes a ...
  reason: missing file internal/app/agents_doctor.go
  reason: missing file internal/app/agents_doctor_test.go
- mem_005 [fresh] score=87 — Make the CLI announce legal moves so an agent never guesses the pipeline stat...
- mem_025 [fresh] score=77 — Make the review loop (both contract_review and code_review, which share inter...
- mem_018 [fresh] score=77 — Add a new top-level CLI command 'pactum usage [run_id]' that summarizes agent...
- mem_027 [fresh] score=67 — Give the CONTRACT-REVIEW loop the same operator finding-resolution that CODE-...
