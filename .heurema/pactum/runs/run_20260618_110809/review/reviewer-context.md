...
- Validation command results:
  - command_001: go test ./internal/app -run 'Plan|Context|Pack|Baseline|Validation|Config|Execute' (exit 0, timed out: false, result: gate/validation/command_001/result.json)
