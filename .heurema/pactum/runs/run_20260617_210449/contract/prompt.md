...
- Approval: approved
- Contract hash: 919707a2dcfd67431e230f43a7a7e8da0b2e4f0b4fe12d1fc59b01709944d20c
...
Items:
- mem_007 [fresh] score=59 — Fix three valid external review findings. (1) pactum export must preserve its...
- mem_011 [fresh] score=49 — Stagger the cold start of same-model reviewer groups in the review panel fan-...
- mem_005 [fresh] score=47 — Make the CLI announce legal moves so an agent never guesses the pipeline stat...
- mem_013 [fresh] score=46 — Dogfood Pactum with a local codex-acp adapter that returns official ACP Promp...
- mem_016 [fresh] score=43 — Port the code-review loop (internal/app/review_loop.go) onto the existing int...
