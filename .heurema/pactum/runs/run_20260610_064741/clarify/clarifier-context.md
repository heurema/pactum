...
## Run
- Run id: run_20260610_064741
- Run status: contract_draft

## Contract draft
- Goal: Sketch a plan for improving error messages
- In scope:
  - none
- Out of scope:
  - none
...
Generated: 2026-06-10T06:47:41Z
...
Generated: 2026-06-10T06:05:39Z
...
- Indexed files: 131
- Ignored files/directories: 876
- Detected languages: 6
- Code items (best-effort hints): 1405
...
- `internal/app/app_test.go`: `go_func` `app.TestClarifyRunNotFoundReturnsError`
- `internal/app/app_test.go`: `go_func` `app.TestClarifyStatusJSONOutput`
- `internal/app/app_test.go`: `go_func` `app.TestClarifyStatusJSONReportsApprovedRun`
...
## Search results
{
  "query": "Sketch a plan for improving error messages",
  "queries": [
    "sketch",
    "plan",
    "improving",
