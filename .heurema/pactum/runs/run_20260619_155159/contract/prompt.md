...
- Approval: approved
- Contract hash: a89dd408203270582fc229a24944be683256840057424066d9ee733c2a8099db
...
Items:
- mem_021 [fresh] score=76 — Make pactum's code-review loop never silently drop reviewer findings, and rec...
- mem_025 [fresh] score=70 — Make the review loop (both contract_review and code_review, which share inter...
- mem_007 [fresh] score=61 — Fix three valid external review findings. (1) pactum export must preserve its...
- mem_022 [fresh] score=59 — Plan-DAG slice 2: the contract drafter emits an optional plan.tasks[] DAG, an...
- mem_011 [fresh] score=58 — Stagger the cold start of same-model reviewer groups in the review panel fan-...
