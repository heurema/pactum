...
- Approval: approved
- Contract hash: 019e33b59237ec217b7c2fb8f55738d9acbe9ab35a74318501f79ac40c8df2dd
...
Items:
- mem_005 [fresh] score=50 — Make the CLI announce legal moves so an agent never guesses the pipeline stat...
...
- mem_012 [fresh] score=38 — Capture Codex token usage from ACP usage_update metadata and add per-engine A...
- mem_011 [fresh] score=38 — Stagger the cold start of same-model reviewer groups in the review panel fan-...
- mem_006 [fresh] score=36 — Smooth the pipeline so no command is pure ritual, then compress the agent ski...
