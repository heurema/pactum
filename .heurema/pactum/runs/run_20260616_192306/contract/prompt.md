...
- Approval: approved
- Contract hash: d8e7d3d4571d7cc62af876affa30f476f94c0a38b123e1754b3c584241aebda0
...
Items:
- mem_007 [fresh] score=67 — Fix three valid external review findings. (1) pactum export must preserve its...
- mem_011 [fresh] score=63 — Stagger the cold start of same-model reviewer groups in the review panel fan-...
- mem_002 [stale] score=41 — Normalize the CLI command grammar for agent-first use: every stage exposes a ...
...
- mem_005 [fresh] score=37 — Make the CLI announce legal moves so an agent never guesses the pipeline stat...
